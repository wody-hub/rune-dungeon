...
## 다음으로 할 일
- `진언/언령 티어별 제작 성공률 표`를 구체 수치로 확정
- `씨앗 ~ 온결` 각 티어별 대표 진언 예시 정리
- `씨앗 ~ 온결` 각 티어별 대표 언령 예시 정리
- `각인 촉매 종류와 획득처` 설계
- `룬 파편 희귀도 표` 설계
...
## 다음 세션 시작 추천 멘트
`progress.md`와 `scratchpad/design-drafts/2026-03-11_incantation-mantra-tier-by-level.md`를 기준으로 이어서 작업해줘. 다음 작업은 씨앗~온결 티어 기준의 진언/언령 제작 성공률 표와 대표 예시 정리야.

## 다음 세션에서 바로 할 수 있는 작업
- 티어별 진언 제작 성공률을 단일 수치 또는 범위로 확정
- 티어별 언령 제작 성공률을 단일 수치 또는 범위로 확정
- 티어별 대표 진언 1~3개씩 초안 작성
- 티어별 대표 언령 1~3개씩 초안 작성
- 각인 촉매의 등급 체계와 획득처 설계
- 자동/수동 드랍 테이블 초안 작성
